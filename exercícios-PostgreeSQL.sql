...
select 
	email, 
	income,
	FLOOR (income / 1200) as "salários-mínimos" --FLOOR arredonda o valor para baixo, removendo os decimais.
from sales.customers
...
select 
	...
	income,
	FLOOR (income / 1200) as "salários-mínimos", --FLOOR arredonda o valor para baixo, removendo os decimais.
		(income / 1200) > 4 as "acima de 4 salários" --verifica novamente o salário min e ve se é > 4 
from sales.customers
